...
class TestAnonymisationPurview(SparkTestCase):
    def test_engine_apply_from_purview_with_mocked_classifications(self):
    ...
    def test_engine_apply_from_purview_honours_classification_allowlist(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test_engine_apply_from_purview_ignores_unsupported_classifications(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test_engine_apply_from_purview_matches_normalised_column_names(self):
        spark = PytestSparkSessionUtil().get_spark_session()
