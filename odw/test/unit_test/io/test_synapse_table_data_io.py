...
class TestSynapseTableDataIO(SparkTestCase):
    def test__synapse_table_data_io__read__successful(self, tmpdir):
    ...
    def test__synapse_table_data_io__write__successful(self, tmpdir):
        spark_session = PytestSparkSessionUtil().get_spark_session()
