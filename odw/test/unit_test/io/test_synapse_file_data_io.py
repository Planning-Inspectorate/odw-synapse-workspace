...
class TestSynapseFileDataIO(SparkTestCase):
    ...
    def test__synapse_file_data_io__read__with_missing_arguments(self, argument_to_drop: str):
        all_arguments = {
            "storage_name": "somestorageaccount",
    ...
    def test__synapse_file_data_io__write__with_missing_arguments(self, argument_to_drop: str):
        spark_session = PytestSparkSessionUtil().get_spark_session()
        mock_dataframe: DataFrame = spark_session.createDataFrame(
            [],
            StructType(
