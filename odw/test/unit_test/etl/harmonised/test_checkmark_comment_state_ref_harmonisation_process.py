...
from odw.core.etl.transformation.harmonised.checkmark_comment_state_ref_harmonisation_process import (
...
_MODULE = "odw.core.etl.transformation.harmonised.checkmark_comment_state_ref_harmonisation_process"
...
class TestCheckmarkCommentStateRefHarmonisationProcess(SparkTestCase):
    ...
    def test__process__data_to_write_has_overwrite_mode(self):
        ...
        assert write_metadata["blob_path"] == "comment_state_ref"
