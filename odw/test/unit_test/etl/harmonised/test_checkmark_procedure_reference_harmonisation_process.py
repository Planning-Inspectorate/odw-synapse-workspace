...
from odw.core.etl.transformation.harmonised.checkmark_procedure_reference_harmonisation_process import (
...
_MODULE = "odw.core.etl.transformation.harmonised.checkmark_procedure_reference_harmonisation_process"
...
class TestCheckmarkProcedureReferenceHarmonisationProcess(SparkTestCase):
    ...
    def test__process__data_to_write_has_overwrite_mode(self):
        ...
        assert write_metadata["blob_path"] == "procedure_reference"
