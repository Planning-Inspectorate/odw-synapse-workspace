...
from odw.core.etl.transformation.harmonised.checkmark_conditions_reference_harmonisation_process import (
...
_MODULE = "odw.core.etl.transformation.harmonised.checkmark_conditions_reference_harmonisation_process"
...
class TestCheckmarkConditionsReferenceHarmonisationProcess(SparkTestCase):
    ...
    def test__process__data_to_write_has_overwrite_mode(self):
        ...
        assert write_metadata["blob_path"] == "conditions_reference"
