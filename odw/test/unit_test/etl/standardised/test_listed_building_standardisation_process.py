...
class TestListedBuildingStandardisationProcess(SparkTestCase):
    ...
    def test__listed_building_standardisation_process__process__returns_both_output_tables(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test__listed_building_standardisation_process__process__flattens_listed_building_entities_like_legacy(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test__listed_building_standardisation_process__process__flattens_listed_building_outline_entities_like_legacy(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test__listed_building_standardisation_process__process__preserves_null_optional_fields_like_legacy(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test__listed_building_standardisation_process__process__uses_overwrite_write_mode_for_both_outputs(self):
        spark = PytestSparkSessionUtil().get_spark_session()
    ...
    def test__listed_building_standardisation_process__process__keeps_expected_column_set_for_each_output(self):
        spark = PytestSparkSessionUtil().get_spark_session()
