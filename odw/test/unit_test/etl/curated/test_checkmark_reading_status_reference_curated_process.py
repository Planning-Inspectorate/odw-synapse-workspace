...
class TestCheckmarkReadingStatusReferenceCuratedProcess(SparkTestCase):
    ...
    def test__process__data_to_write_has_correct_metadata(self):
        ...
        assert write_metadata["blob_path"] == "checkmarkdata/pbi_reading_status_reference"
        assert write_metadata["table_name"] == "pbi_reading_status_reference"
    ...
    def test__process__output_table_path_is_correct(self):
        ...
        assert out_key == "odw_curated_db.pbi_reading_status_reference"
