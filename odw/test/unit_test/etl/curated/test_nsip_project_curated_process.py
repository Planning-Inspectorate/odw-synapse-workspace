...
def test__nsip_project_curated_process__get_name__returns_expected_name():
...
def test__nsip_project_curated_process__process__keeps_only_latest_horizon_record_per_case():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__filters_to_horizon_rows_only_case_insensitively():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__joins_applicant_service_user_and_overrides_applicant_id():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__filters_out_non_applicant_service_user_matches():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__filters_out_rows_with_no_matching_service_user():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__lowercases_publish_status():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__maps_ww01_project_type_exactly_like_legacy():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__preserves_business_fields_selected_by_legacy_view():
    spark = PytestSparkSessionUtil().get_spark_session()
...
def test__nsip_project_curated_process__process__output_columns_match_legacy_view_shape():
    spark = PytestSparkSessionUtil().get_spark_session()
