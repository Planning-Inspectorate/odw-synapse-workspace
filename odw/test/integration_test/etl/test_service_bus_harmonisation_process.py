...
class TestServiceBusHarmonisationProcess(ETLTestCase):
    ...
    def test__service_bus_harmonisation_process__run__with_existing_data_same_schema(self):
        ...
        with mock.patch.object(F, "input_file_name", return_value=F.lit("some_input_file")):
            with mock.patch.object(Util, "display_dataframe"):
                ...
                result = inst.run(orchestration_run_id="t_sbhp_r_wedss", orchestration_entity_name="some_entity", orchestration_stage_name="harmonise", entity_name="test_sb_hrm_pc_exst_data")
    ...
    def test__service_bus_harmonisation_process__run__with_existing_data_different_schema(self):
        ...
        with mock.patch.object(F, "input_file_name", return_value=F.lit("some_input_file")):
            with mock.patch.object(Util, "display_dataframe"):
                inst = ServiceBusHarmonisationProcess(spark)
                result = inst.run(orchestration_run_id="t_sbhp_r_wedds", orchestration_entity_name="some_entity", orchestration_stage_name="harmonise", entity_name="test_sb_hrm_pc_chg_schema")
                assert_etl_result_successful(result)
    ...
    def test__service_bus_harmonisation_process__run__with_no_existing_data(self):
        ...
        with mock.patch.object(F, "input_file_name", return_value=F.lit("some_input_file")):
            with mock.patch.object(Util, "display_dataframe"):
                inst = ServiceBusHarmonisationProcess(spark)
                result = inst.run(orchestration_run_id="t_sbhp_r_wned", orchestration_entity_name="some_entity", orchestration_stage_name="harmonise", entity_name="test_sb_hrm_pc_no_data")
                assert_etl_result_successful(result)
