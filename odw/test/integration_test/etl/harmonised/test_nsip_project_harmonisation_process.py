...
class TestNsipProjectHarmonisationProcess(ETLTestCase):
    ...
    def test__nsip_project_harmonisation_process__run__with_no_existing_data(self):
        """
        - Given
            - I have some service bus NSIP project data in the harmonised layer
            - Some horizon NSIP project data in the standardised layer
        - When I call NsipProjectHarmonisationProcess.run
        - Then the harmonised NSIP project data should be correctly created
        """
    ...
    def test__nsip_project_harmonisation_process__run__with_existing_data(self):
        ...
        - Given
            - I have some service bus NSIP project data in the harmonised layer
            - Some horizon NSIP project data in the standardised layer
            - An existing NSIP project harmonised table
        - When I call NsipProjectHarmonisationProcess.run
        - Then the harmonised NSIP project data should be correctly created
        """
        spark = PytestSparkSessionUtil().get_spark_session()
