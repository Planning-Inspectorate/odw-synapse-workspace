...
class CheckmarkCommentStateRefHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark comment_state_ref reference data.
    ...
    OUTPUT_TABLE = "odw_harmonised_db.comment_state_ref"
    ...
    def get_name(cls) -> str:
        return "checkmark-comment-state-ref-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "comment_state_ref",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "comment_state_ref",
                "file_format": "delta",
