...
class CheckmarkLevelReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark level_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.levelreference"
    OUTPUT_TABLE = "odw_harmonised_db.level_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-level-reference-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "level_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "level_reference",
                "file_format": "delta",
