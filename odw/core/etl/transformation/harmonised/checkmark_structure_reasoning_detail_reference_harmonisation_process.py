...
class CheckmarkStructureReasoningDetailReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark structure_reasoning_detail_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.structurereasoningdetailreference"
    OUTPUT_TABLE = "odw_harmonised_db.structure_reasoning_detail_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-structure-reasoning-detail-reference-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "structure_reasoning_detail_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "structure_reasoning_detail_reference",
                "file_format": "delta",
