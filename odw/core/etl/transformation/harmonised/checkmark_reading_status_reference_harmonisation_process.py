...
class CheckmarkReadingStatusReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark reading_status_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.readingstatusreference"
    OUTPUT_TABLE = "odw_harmonised_db.reading_status_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-reading-status-reference-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "reading_status_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "reading_status_reference",
                "file_format": "delta",
