...
class AppealS78HarmonisationProcess(HarmonisationProcess):
    ...
    def _load_appeal_has_data(self) -> DataFrame:
        raise NotImplementedError("AppealS78HarmonisationProcess._load_appeal_has_data() has not been implemented yet.")
    ...
    def _clean_appeal_has_data(self, raw_has_data: DataFrame) -> DataFrame:
        raise NotImplementedError("AppealS78HarmonisationProcess._clean_appeal_has_data() has not been implemented yet.")
    ...
    def _apply_slowly_changing_dimensions(
        self, clean_aggregate_data: DataFrame, appeal_has_data: DataFrame, service_bus_data: DataFrame
    ) -> DataFrame:
