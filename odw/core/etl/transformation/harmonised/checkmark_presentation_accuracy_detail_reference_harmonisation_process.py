...
class CheckmarkPresentationAccuracyDetailReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark presentation_accuracy_detail_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.presentationaccuracydetailreference"
    OUTPUT_TABLE = "odw_harmonised_db.presentation_accuracy_detail_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-presentation-accuracy-detail-reference-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "presentation_accuracy_detail_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "presentation_accuracy_detail_reference",
                "file_format": "delta",
