...
class CheckmarkSourceReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark source_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.sourcereference"
    OUTPUT_TABLE = "odw_harmonised_db.source_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-source-reference-harmonised"
