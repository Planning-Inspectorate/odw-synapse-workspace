...
class CheckmarkCommentTypeRefHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark comment_type_ref reference data.
    ...
    OUTPUT_TABLE = "odw_harmonised_db.comment_type_ref"
    ...
    def get_name(cls) -> str:
        return "checkmark-comment-type-ref-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "comment_type_ref",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "comment_type_ref",
                "file_format": "delta",
