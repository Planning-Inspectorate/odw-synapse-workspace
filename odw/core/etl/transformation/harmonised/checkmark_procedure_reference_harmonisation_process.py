...
class CheckmarkProcedureReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark procedure_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.procedurereference"
    OUTPUT_TABLE = "odw_harmonised_db.procedure_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-procedure-reference-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "procedure_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "procedure_reference",
                "file_format": "delta",
