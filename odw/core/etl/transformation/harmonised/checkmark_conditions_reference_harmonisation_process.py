...
class CheckmarkConditionsReferenceHarmonisationProcess(HarmonisationProcess):
    """
    Harmonisation process for Checkmark conditions_reference reference data.
    ...
    SOURCE_TABLE = "odw_standardised_db.conditionreference"
    OUTPUT_TABLE = "odw_harmonised_db.conditions_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-conditions-reference-harmonised"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "conditions_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-harmonised",
                "blob_path": "conditions_reference",
                "file_format": "delta",
