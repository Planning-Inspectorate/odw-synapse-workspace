...
class CheckmarkReadingCaseCuratedProcess(CurationProcess):
    """
    Curated layer process for Checkmark pbi_reading_case — produces the Power BI
    consumption table from the harmonised reading_case table.
    ...
    SOURCE_TABLE = "odw_harmonised_db.reading_case"
    OUTPUT_TABLE = "odw_curated_db.pbi_reading_case"
    ...
    def get_name(cls) -> str:
        return "checkmark-reading-case-curated"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "pbi_reading_case",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-curated",
                "blob_path": "checkmarkdata/pbi_reading_case",
                "file_format": "delta",
