...
class CheckmarkSourceReferenceCuratedProcess(CurationProcess):
    """
    Curated layer process for Checkmark pbi_source_reference — produces the Power BI
    consumption table from the harmonised source_reference table.
    ...
    SOURCE_TABLE = "odw_harmonised_db.source_reference"
    OUTPUT_TABLE = "odw_curated_db.pbi_source_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-source-reference-curated"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "pbi_source_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-curated",
                "blob_path": "checkmarkdata/pbi_source_reference",
                "file_format": "delta",
