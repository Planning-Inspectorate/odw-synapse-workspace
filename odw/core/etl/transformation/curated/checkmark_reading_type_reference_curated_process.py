...
class CheckmarkReadingTypeReferenceCuratedProcess(CurationProcess):
    """
    Curated layer process for Checkmark pbi_reading_type_reference — produces the Power BI
    consumption table from the harmonised reading_type_reference table.
    ...
    SOURCE_TABLE = "odw_harmonised_db.reading_type_reference"
    OUTPUT_TABLE = "odw_curated_db.pbi_reading_type_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-reading-type-reference-curated"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "pbi_reading_type_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-curated",
                "blob_path": "checkmarkdata/pbi_reading_type_reference",
                "file_format": "delta",
