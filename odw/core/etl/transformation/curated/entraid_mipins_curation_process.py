...
class EntraIDMIPINSCurationProcess(CurationProcess):
    ...
    def load_data(self, **kwargs) -> Dict[str, DataFrame]:
        raise NotImplementedError(
            "EntraIDMIPINSCurationProcess.load_data() has not been implemented yet."
        )

    def _clean_data(self, raw_entraid_data: DataFrame):
        raise NotImplementedError(
            "EntraIDMIPINSCurationProcess._clean_data() has not been implemented yet."
        )

    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        raise NotImplementedError(
            "EntraIDMIPINSCurationProcess.process() has not been implemented yet."
        )
