...
class CheckmarkConditionsReferenceCuratedProcess(CurationProcess):
    """
    Curated layer process for Checkmark pbi_conditions_reference — produces the Power BI
    consumption table from the harmonised conditions_reference table.
    ...
    SOURCE_TABLE = "odw_harmonised_db.conditions_reference"
    OUTPUT_TABLE = "odw_curated_db.pbi_conditions_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-conditions-reference-curated"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "pbi_conditions_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-curated",
                "blob_path": "checkmarkdata/pbi_conditions_reference",
                "file_format": "delta",
