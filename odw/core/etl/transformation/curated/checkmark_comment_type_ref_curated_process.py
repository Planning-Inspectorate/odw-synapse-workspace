...
class CheckmarkCommentTypeRefCuratedProcess(CurationProcess):
    """
    Curated layer process for Checkmark pbi_comment_type_ref — produces the Power BI
    consumption table from the harmonised comment_type_ref table.
    ...
    SOURCE_TABLE = "odw_harmonised_db.comment_type_ref"
    OUTPUT_TABLE = "odw_curated_db.pbi_comment_type_ref"
    ...
    def get_name(cls) -> str:
        return "checkmark-comment-type-ref-curated"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "pbi_comment_type_ref",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-curated",
                "blob_path": "checkmarkdata/pbi_comment_type_ref",
                "file_format": "delta",
