...
class CheckmarkOutcomeReferenceCuratedProcess(CurationProcess):
    """
    Curated layer process for Checkmark pbi_outcome_reference — produces the Power BI
    consumption table from the harmonised outcome_reference table.
    ...
    SOURCE_TABLE = "odw_harmonised_db.outcome_reference"
    OUTPUT_TABLE = "odw_curated_db.pbi_outcome_reference"
    ...
    def get_name(cls) -> str:
        return "checkmark-outcome-reference-curated"
    ...
    def process(self, **kwargs) -> Tuple[Dict[str, DataFrame], ETLResult]:
        ...
        data_to_write = {
            self.OUTPUT_TABLE: {
                ...
                "table_name": "pbi_outcome_reference",
                "storage_endpoint": Util.get_storage_account(),
                "container_name": "odw-curated",
                "blob_path": "checkmarkdata/pbi_outcome_reference",
                "file_format": "delta",
